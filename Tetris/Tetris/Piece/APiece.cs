...
namespace Tetris.Piece
{
    abstract class APiece
    {
        ...
        private void updatePiece(ContentManager content)
        {
            ...
            {
                    block.Position = new Vector2(Common.boardStartX + ((this.X_axis + block.X_axis)-1) * Common.blockTextureSize, Common.boardStartY + ((this.Y_axis - block.Y_axis)-4) * Common.blockTextureSize);
            }
        }
